...
var button_style = __webpack_require__(316);
...
var product_icon_style = __webpack_require__(318);
...
/* harmony import */ var _woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(17);
/**
 * External dependencies
 */
...
const getInAppPurchaseUrl = (url, queryArgs = {}) => {
  ...
  const connectNonce = Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_1__[/* getSetting */ "h"])('connectNonce', '');
  queryArgs = {
    'wccom-site': Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_1__[/* getSetting */ "h"])('siteUrl'),
    // If the site is installed in a directory the directory must be included in the back param path.
    'wccom-back': pathname + search,
    'wccom-woo-version': Object(_woocommerce_wc_admin_settings__WEBPACK_IMPORTED_MODULE_1__[/* getSetting */ "h"])('wcVersion'),
...
var components = __webpack_require__(119);
...
const {
  installedExtensions
} = Object(wc_admin_settings["h" /* getSetting */])('marketing', {});
const DEFAULT_STATE = {
...
var installed_extensions_style = __webpack_require__(609);
...
class row_InstalledExtensionRow extends external_wp_element_["Component"] {
  constructor(props) {
    super(props);
  ...
  getLinks() {
    ...
    if (docsUrl) {
      links.push({
        key: 'docs',
        href: docsUrl,
        text: Object(external_wp_i18n_["__"])('Docs', 'woocommerce-admin')
      });
    }
    ...
    if (supportUrl) {
      links.push({
        key: 'support',
        href: supportUrl,
        text: Object(external_wp_i18n_["__"])('Get support', 'woocommerce-admin')
      });
    }
    ...
    if (settingsUrl) {
      links.push({
        key: 'settings',
        href: settingsUrl,
        text: Object(external_wp_i18n_["__"])('Settings', 'woocommerce-admin')
      });
    }
    ...
    if (dashboardUrl) {
      links.push({
        key: 'dashboard',
        href: dashboardUrl,
        text: Object(external_wp_i18n_["__"])('Dashboard', 'woocommerce-admin')
      });
    }
  ...
  onLinkClick(link) {
    ...
    Object(external_wc_tracks_["recordEvent"])('marketing_installed_options', {
      name,
      link: link.key
    });
  }
  ...
  onActivateClick() {
    ...
    Object(external_wc_tracks_["recordEvent"])('marketing_installed_activate', {
      name
    });
    activatePlugin();
  }
  ...
  onFinishSetupClick() {
    ...
    Object(external_wc_tracks_["recordEvent"])('marketing_installed_finish_setup', {
      name
    });
  }
  ...
  getActivateButton() {
    ...
    return Object(external_wp_element_["createElement"])(components["a" /* Button */], {
      isSecondary: true,
      onClick: this.onActivateClick,
      disabled: isLoading
    }, Object(external_wp_i18n_["__"])('Activate', 'woocommerce-admin'));
  }
  ...
  render() {
    ...
    }, Object(external_wp_element_["createElement"])("h4", null, name), status === 'configured' || Object(external_wp_element_["createElement"])("p", {
...
class installed_extensions_InstalledExtensions extends external_wp_element_["Component"] {
  ...
  render() {
    ...
    const title = Object(external_wp_i18n_["__"])('Installed marketing extensions', 'woocommerce-admin');
    ...
    return Object(external_wp_element_["createElement"])(external_wp_components_["Card"], {
      ...
      return Object(external_wp_element_["createElement"])(row, extends_default()({
        key: plugin.slug
      }, plugin, {
...
/* harmony default export */ var installed_extensions = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  const {
    getInstalledPlugins,
  ...
  const {
    activateInstalledPlugin
  } = dispatch(constants["b" /* STORE_KEY */]);
  return {
    activateInstalledPlugin
  };
...
const WelcomeCard = ({
  ...
  const hide = () => {
    ...
    Object(external_wc_tracks_["recordEvent"])('marketing_intro_close', {});
  };
  ...
  }, Object(external_wp_element_["createElement"])(external_wp_components_["CardBody"], null, Object(external_wp_element_["createElement"])(external_wp_components_["Button"], {
    label: Object(external_wp_i18n_["__"])('Hide', 'woocommerce-admin'),
    onClick: hide,
    className: "woocommerce-marketing-overview-welcome-card__hide-button"
  }, Object(external_wp_element_["createElement"])(cross_default.a, null)), Object(external_wp_element_["createElement"])("img", {
    src: welcome_default.a,
    alt: ""
  }), Object(external_wp_element_["createElement"])("h3", null, Object(external_wp_i18n_["__"])('Grow your customer base and increase your sales with marketing tools built for WooCommerce', 'woocommerce-admin'))));
};
...
/* harmony default export */ var welcome_card = (Object(external_wp_compose_["compose"])(Object(external_wp_data_["withSelect"])(select => {
  const {
    getOption,
    isOptionsUpdating
...
var data = __webpack_require__(320);
...
const MarketingOverview = () => {
  const allowMarketplaceSuggestions = Object(wc_admin_settings["h" /* getSetting */])('allowMarketplaceSuggestions', false);
  return Object(external_wp_element_["createElement"])("div", {
    className: "woocommerce-marketing-overview"
  }, Object(external_wp_element_["createElement"])(welcome_card, null), Object(external_wp_element_["createElement"])(installed_extensions, null), allowMarketplaceSuggestions && Object(external_wp_element_["createElement"])(recommended_extensions["a" /* default */], {
    category: "marketing"
...
/* harmony default export */ var overview = __webpack_exports__["default"] = (Object(external_wc_data_["withOptionsHydration"])({ ...(window.wcSettings.preloadOptions || {})
})(MarketingOverview));
...
/* harmony import */ var _woocommerce_experimental__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22);
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(317);
