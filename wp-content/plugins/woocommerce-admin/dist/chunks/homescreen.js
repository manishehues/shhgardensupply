...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(584);
...
var quick_link_category_style = __webpack_require__(603);
...
var quick_link_style = __webpack_require__(604);
...
const StoreManagementLinks = () => {
  const shopUrl = Object(wc_admin_settings["h" /* getSetting */])('shopUrl');
...
class orders_OrdersPanel extends external_wp_element_["Component"] {
  ...
  renderOrders() {
    ...
    const orderCardTitle = order => {
      ...
      const customerUrl = customer.customer_id ? Object(external_wc_navigation_["getNewPath"])({}, '/analytics/customers', {
      ...
      return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, lib_default()({
        ...
        components: {
          orderLink: Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
            href: Object(wc_admin_settings["g" /* getAdminLink */])('post.php?action=edit&post=' + orderId),
            onClick: () => this.recordOrderEvent('order_number'),
            type: "wp-admin"
          }),
          ...
          customerLink: customerUrl ? Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
            href: customerUrl,
            onClick: () => this.recordOrderEvent('customer_name'),
            type: "wc-admin"
    ...
    orders.forEach(order => {
      ...
      const productsCount = extendedInfo && extendedInfo.products ? extendedInfo.products.length : 0;
      ...
      cards.push(Object(external_wp_element_["createElement"])(activity_card["a" /* ActivityCard */], {
        ...
        onClick: ({
          ...
          if (!target.href) {
            window.location.href = Object(wc_admin_settings["g" /* getAdminLink */])(`post.php?action=edit&post=${orderId}`);
          }
        },
        ...
        order: order,
        orderStatusMap: Object(wc_admin_settings["h" /* getSetting */])('orderStatuses', {})
      })));
    });
    ...
    if (isError) {
      if (!orderStatuses.length) {
        return Object(external_wp_element_["createElement"])(external_wc_components_["EmptyContent"], {
          ...
          actionURL: Object(wc_admin_settings["g" /* getAdminLink */])('admin.php?page=wc-admin&path=/analytics/settings')
        });
      }
...
/* harmony default export */ var activity_panel_orders = (Object(external_wp_data_["withSelect"])((select, props) => {
  const {
    countUnreadOrders,
    orderStatuses
  } = props;
  ...
  const isRequesting = isResolving('getReportItems', ['orders', ordersQuery]);
  ...
  if (reportOrders.length) {
    ...
    const actionableOrdersById = Object(external_lodash_["keyBy"])(actionableOrders, 'id');
    orders = reportOrders.map(order => Object(external_lodash_["merge"])({}, order, actionableOrdersById[order.order_id] || {}));
  }
...
class card_ProductStockCard extends external_wp_element_["Component"] {
  ...
  render() {
    ...
    const notifyLowStockAmount = Object(wc_admin_settings["h" /* getSetting */])('notifyLowStockAmount', 0);
...
var reviews_style = __webpack_require__(596);
...
class reviews_ReviewsPanel extends external_wp_element_["Component"] {
    ...
    const title = lib_default()({
      ...
      components: {
        ...
        authorLink: Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
          href: Object(wc_admin_settings["g" /* getAdminLink */])('admin.php?page=wc-admin&path=%2Fcustomers&search=' + review.reviewer),
  ...
  renderReviews(reviews) {
    ...
    return Object(external_wp_element_["createElement"])(external_wp_element_["Fragment"], null, renderedReviews, Object(external_wp_element_["createElement"])(external_wc_components_["Link"], {
      href: Object(wc_admin_settings["g" /* getAdminLink */])('edit-comments.php?comment_type=review'),
...
var client_utils = __webpack_require__(561);
...
const ActivityPanel = () => {
  const panelsData = Object(external_wp_data_["useSelect"])(select => {
    const totalOrderCount = Object(wc_admin_settings["h" /* getSetting */])('orderCount', 0);
    const orderStatuses = Object(utils["c" /* getOrderStatuses */])(select);
    const reviewsEnabled = Object(wc_admin_settings["h" /* getSetting */])('reviewsEnabled', 'no');
    const countUnreadOrders = Object(utils["d" /* getUnreadOrders */])(select, orderStatuses);
    const manageStock = Object(wc_admin_settings["h" /* getSetting */])('manageStock', 'no');
    ...
    const publishedProductCount = Object(wc_admin_settings["h" /* getSetting */])('publishedProductCount', 0);
    const {
      getOption
...
var nav_intro_2 = __webpack_require__(599);
...
var nav_intro_3 = __webpack_require__(600);
...
var stats_overview_style = __webpack_require__(601);
...
var store_performance_utils = __webpack_require__(570);
...
const InstallJetpackCTA = () => {
  ...
  const onClickInstall = () => {
    installJetpackAndConnect(createErrorNotice, wc_admin_settings["g" /* getAdminLink */]);
  };
...
} = Object(wc_admin_settings["h" /* getSetting */])('dataEndpoints', {
  performanceIndicators: []
});
...
var store_management_links = __webpack_require__(586);

// EXTERNAL MODULE: ./client/task-list/placeholder.js
var placeholder = __webpack_require__(583);
...
var welcome_from_calypso_modal_style = __webpack_require__(605);
...
var welcome_modal_style = __webpack_require__(606);
...
var homescreen_style = __webpack_require__(607);

// EXTERNAL MODULE: ./client/dashboard/style.scss
var dashboard_style = __webpack_require__(563);
...
const TaskList = Object(external_wp_element_["lazy"])(() => Promise.all(/* import() | task-list */[__webpack_require__.e(3), __webpack_require__.e(49)]).then(__webpack_require__.bind(null, 650)));
const Layout = ({
  ...
  const twoColumns = (userPrefs.homepage_layout || defaultHomescreenLayout) === 'two_columns';
...
const onboardingData = Object(wc_admin_settings["h" /* getSetting */])('onboarding', {});
