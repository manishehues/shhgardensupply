...
const stockStatuses = Object(wc_admin_settings["h" /* getSetting */])('stockStatuses', {});
...
class table_StockReportTable extends external_wp_element_["Component"] {
  ...
  getRowsContent(products = []) {
    ...
    return products.map(product => {
      ...
      const editProductLink = Object(wc_admin_settings["g" /* getAdminLink */])('post.php?action=edit&post=' + (parentId || id));
