...
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">Just to let you know — we've received your order #{order_id}, and it is now being processed:<br style="color: #636363; font-size: 14px;">
</div>
</td>
			</tr></tbody></table>
<?php if(isset($order)){ 
