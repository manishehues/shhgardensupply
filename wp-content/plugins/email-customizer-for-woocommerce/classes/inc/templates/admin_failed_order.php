...
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">Payment for order #{order_id} from {customer_full_name} has failed. The order was as follows:<br style="color: #636363; font-size: 14px;">
</div>				</td>
			</tr></tbody></table>
<?php if(isset($order)){ 
