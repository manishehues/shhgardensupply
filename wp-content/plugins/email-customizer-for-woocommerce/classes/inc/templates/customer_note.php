...
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">The following note has been added to your order: {customer_note} As a reminder, here are your order details:<br style="color: #636363; font-size: 14px;">
</div>
</td>
			</tr></tbody></table>
<?php if(isset($order)){ 
