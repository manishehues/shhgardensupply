...
<td class="thwecmf-block-text-holder" style='vertical-align: top; box-sizing: border-box; width: 100%; font-family: "Helvetica Neue",Helvetica,Roboto,Arial,sans-serif; line-height: 22px; padding: 15px 15px; color: #636363; font-size: 14px; text-align: left; background-color: transparent; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; border-color: transparent; border-style: none; padding-top: 0px; padding-right: 0px; padding-bottom: 20px; padding-left: 0px;'>
					<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">Hi <?php if(isset($order)) : ?><?php echo esc_html($order->get_billing_first_name()).' '.esc_html($order->get_billing_last_name()); ?><?php elseif(isset($user_login)): ?><?php echo esc_html($user_login); ?><?php endif; ?>,<br style="color: #636363; font-size: 14px;">
</div>
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;"><br style="color: #636363; font-size: 14px;"></div>
<div class="wecmf-txt-wrap" style="color: #636363; font-size: 14px;">Alas. Just to let you know — order #{order_id} belonging to {customer_full_name} has been cancelled:<br style="color: #636363; font-size: 14px;">
</div>				</td>
			</tr></tbody></table>
<?php if(isset($order)){ 
